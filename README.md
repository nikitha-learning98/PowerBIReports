...
### Description: 
In this Power BI case study, I have investigated a dataset from an example telecom company and analyzed why customers are leaving. Analyzing churn doesn't just mean knowing what the churn rate is but also figuring out why customers are churning at the rate they are.
...
### Data Source: 
The data source used for this analysis is a CSV dataset obtained from Datacamp's couse Case Study.
...
![Preview](https://github.com/nikitha-learning98/PowerBIReports/blob/main/Overview%20of%20Churn%20Rate.png)
